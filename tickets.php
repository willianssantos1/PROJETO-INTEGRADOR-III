...
<body>
  <main>
    ...
    <div class="container">
            ...
            <div class="row">
                <p>
                    <a href="ticketscreate.php" class="btn btn-success">Criar Tickets</a>
                    <a href="ticketsencerrado.php" class="btn btn-outline-dark">Tickets Encerrados</a>
                    <a href="ticketsagenda.php" class="btn btn-outline-primary">Agenda</a>
                    <a href="ticketsinterno.php" class="btn btn-outline-dark">Tickets Interno</a>
                    <a href="ticketsmanutencao.php" class="btn btn-outline-warning">Manutenção Programada</a>
                </p>
                <div class="container">
