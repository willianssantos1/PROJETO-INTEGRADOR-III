    ...
    <div class="container">
             ...
             <div class="span10 offset1">
                  <div class="card">
                    ...
                    <h3 class="well">Painel dos Usuários:</h3>
                </div>
            </div>
            </div>
                <br>
            ...
            <div class="row">
                <p>
                    <a href="usuariocreate.php" class="btn btn-success">Adicionar Usuário</a>
                    <a href="usuariocreatedepartamento.php" class="btn btn-success">Adicionar Departamento</a>
